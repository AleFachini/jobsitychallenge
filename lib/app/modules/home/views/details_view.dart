...
mainAxisAlignment: MainAxisAlignment.center,
children: [
Text('Air on: ${argumentShow.scheduleDays}'),
Text(' at ${argumentShow.time}.'),
],
),
Text('Genres: ${argumentShow.genres}'),
Container(
padding: EdgeInsets.all(16),
child: Html(
data: '${argumentShow.summary}',
defaultTextStyle: TextStyle(
color: Colors.white,
),
),
